...
function ShoppingBagIconWithBadge(count: number | null) {
  return <div className="relative inline-flex">
    ...
    <ShoppingBagIcon />
    {count !== null && count > 0 && <span className="absolute top-0 right-0 inline-flex items-center justify-center px-[4px] py-[2px] text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">
      {count}
    </span>}
  </div>
}
